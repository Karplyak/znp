...
rem   Revised:        $Date: 2010-07-27 18:10:31 -0700 (Tue, 27 Jul 2010) $
rem   Revision:       $Revision: 23156 $
rem 
rem   Description:    This file is a launcher for the znp.js.
rem 
rem 
rem   Copyright 2010 Texas Instruments Incorporated. All rights reserved.
rem 
