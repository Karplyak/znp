/**************************************************************************************************
  Filename:       ZGlobals.c
  Revised:        $Date: 2010-08-18 18:19:45 -0700 (Wed, 18 Aug 2010) $
  Revision:       $Revision: 23451 $
...
uint8 zgApsfMaxWindowSize = APSF_DEFAULT_WINDOW_SIZE;

// The delay between tx packets when using fragmentaition
uint16 zgApsfInterframeDelay = APSF_DEFAULT_INTERFRAME_DELAY;
...
static CONST zgItem_t zgItemTable[] =
{
  ...
  {
    ZCD_NV_APSF_WINDOW_SIZE, sizeof(zgApsfMaxWindowSize), &zgApsfMaxWindowSize
  },
  {
    ZCD_NV_APSF_INTERFRAME_DELAY, sizeof(zgApsfInterframeDelay), &zgApsfInterframeDelay
  },
  {
