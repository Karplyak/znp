/**************************************************************************************************
  ...
  Revised:        $Date: 2010-07-22 11:33:42 -0700 (Thu, 22 Jul 2010) $
  Revision:       $Revision: 23104 $
...
#define HAL_SLEEP_PREP_IDLE_MODE()          st( SLEEPCMD &= ~PMODE; /* clear mode bits */    \
                                                halSleepPconValue = PCON_IDLE;               \
                                              )
...
#define HAL_SLEEP_PREP_IDLE_MODE(mode)
